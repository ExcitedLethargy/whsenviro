...
import {setGlobal, gFirebaseConfig, gFirebaseApp, gFirestoreDB} 
    from '../master/firebaseGlobals.js';
...
export function firebaseInit() {
    ...
    setGlobal(gFirebaseConfig, vFirebaseConfig);
    setGlobal(gFirebaseApp, vApp);
    setGlobal(gFirestoreDB, vDB);
}